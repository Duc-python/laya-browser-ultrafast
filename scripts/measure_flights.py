...
from laya_browser_ultrafast import Agent  # noqa: E402
from laya_browser_ultrafast import browser as browser_module  # noqa: E402
...
source_hashes = {
    ...
    for p in (source / "laya_browser_ultrafast").iterdir() if p.suffix in {".py", ".js"}
}
